...
from .views import ProgramList, ProgramCreation, ProgramUpdate, ProgramDetail, SubProgramList, SubProgramList, SubprogramCreation, SubProgramUpdate, SubProgramDetail, SubProgramTaskDetail, SubProgramTaskAdd, TaskAdvanceDetail, TaskAdvanceAdd, SubProgramTaskList
...
urlpatterns = [
    ...
    path('subprogramtask_list', SubProgramTaskList.as_view(), name='subprogramtask_list'),
